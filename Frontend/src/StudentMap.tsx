...
const StateUniversityMap: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="d-flex flex-column vh-100" style={{ fontFamily: 'Arial, sans-serif' }}>
        <div className="bg-white p-3 d-flex align-items-center border-bottom gap-4">
          <img 
            src="../public/huskylogo.png"
            alt="Hillcrest High School Logo" 
            style={{ height: '6rem', width: '6rem', marginLeft: '1rem' }}
          />
         <h1 className="fw-bold m-0" style={{ fontSize: '3.5rem' }}>Hillcrest High School</h1>
        </div>
...
export default StateUniversityMap;
